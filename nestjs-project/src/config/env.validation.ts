...
export const envValidationSchema = Joi.object({
  ...
  STORAGE_ENDPOINT_INTERNAL: Joi.string().uri().required(),
  STORAGE_ENDPOINT_PUBLIC: Joi.string().uri().required(),
  STORAGE_REGION: Joi.string().required(),
  STORAGE_ACCESS_KEY: Joi.string().required(),
  STORAGE_SECRET_KEY: Joi.string().required(),
  STORAGE_BUCKET_VIDEOS: Joi.string().required(),
  STORAGE_BUCKET_THUMBNAILS: Joi.string().required(),
